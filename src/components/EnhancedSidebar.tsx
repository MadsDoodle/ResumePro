...
const EnhancedSidebar = () => {
  ...
  return <>
      <Sidebar className="border-r border-purple-500/20 bg-[#060315]/95 backdrop-blur-sm">
        <SidebarHeader className="p-4 bg-gradient-to-r from-purple-600/20 to-blue-600/20 border-b border-purple-500/20 bg-black/95">
        ...
        <SidebarContent className="bg-[#060315]/95">
          <SidebarMenuComponent items={mainItems} activeItem={activeItem} onItemClick={handleItemClick} label="Main Menu" />

          <div className="mt-auto">
            <SidebarMenuComponent items={bottomItems} activeItem={activeItem} onItemClick={handleItemClick} label="" />
          </div>
        </SidebarContent>

        <SidebarFooter className="p-4 from-purple-600/20 to-blue-600/20 border-t border-purple-500/20 bg-[i#] bg-[#060315]/95">
      ...
      <LibraryModal isOpen={isLibraryOpen} onOpenChange={setIsLibraryOpen} resumeLibrary={resumeLibrary} />

      <ChatModal isOpen={isChatOpen} onOpenChange={setIsChatOpen} chatHistory={chatHistory} />

      <BookmarksModal isOpen={isBookmarksOpen} onOpenChange={setIsBookmarksOpen} bookmarkedPaths={bookmarkedPaths} />
    </>;
};
